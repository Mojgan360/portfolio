...
import robot from "../../images/robot-site.png";
      ...
      <Box component="div" className={classes.mainContainer}>
        <Grid container justify="center">
          <Grid item xs={12} sm={8} md={6}>
            {/* Start import robot from "../../images/robot-site.png";
             */}
            <Card className={classes.cardContainer}>
              <CardActionArea>
                ...
                <CardContent>
                  ...
                  <h4> Robot News Website</h4>
                </CardContent>
              </CardActionArea>
              <CardActions>
                <Button
                  href="https://robot-news.netlify.app/"
                  size="small"
                  color="primary"
                >
                  Live Demo
                ...
                <Button
                  href="https://github.com/Mojgan360/robot-website"
                  size="small"
                  color="primary"
                >
                  Source Code
